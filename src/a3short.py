...
def get_json_data():
    ...
    # Selecting a subset of samples for training and validation. This is to limit the resources being spend
...
def train_classifier(train_images, test_images, val_images):
    ...
    history = model.fit(
        train_images,
        # Indicating that the model should train on all the data in the subsets i defined earlier
